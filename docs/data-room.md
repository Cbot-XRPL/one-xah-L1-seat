...
- [ ] Short bios + roles + (optional) r-addresses for the full council: Cbot (Cody), gadget78 (Mick), 7Rays (Mike), Big Green Candle (Dane) - Big Green Candle's audit work appears nowhere in the repos, so this must be written fresh.
